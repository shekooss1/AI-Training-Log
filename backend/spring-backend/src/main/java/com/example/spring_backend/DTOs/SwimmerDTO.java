...
public record  SwimmerDTO(Long id ,double age, Especiality especiality, String name, Sex sex, Stroke stroke) {
  public static SwimmerDTO from(Swimmer entity) {
        return new SwimmerDTO(entity.getId(),entity.getAge(), entity.getEspeciality(), entity.getName(), entity.getSex(), entity.getStroke());
    }
